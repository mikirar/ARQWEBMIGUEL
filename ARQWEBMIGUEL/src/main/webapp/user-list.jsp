...
<html>
    ...
    <body>
        ...
        <div class="row">
                    ...
                    <tbody>
                        <c:forEach items="${users}" var="user">
                            <tr>
                                ...
                                <td><a href="UsuarioControlador?action=edit&userid=${user.userid}"" style="text-decoration: none; font-size: 15px" class="edit-button"">Editar</a></td>
                                <td><a href="UsuarioControlador?action=delete&userid=${user.userid}"" style="text-decoration: none; font-size: 15px" class="delete-button">Eliminar</a></td>
                                <td><a href="InformesControlador?action=menu&userid=${user.userid}&nombre_usuario=${user.nombre}"" style="text-decoration: none; font-size: 15px" class="report-button"">Report</a></td>
            ...
            <p><a href="UsuarioControlador?action=insert" style="text-decoration: none; font-size: 20px" class="usuario-button"">Añadir Usuario</a></p>
