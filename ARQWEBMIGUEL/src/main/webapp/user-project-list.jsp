...
<html>
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="container">
                <h3 class="text-center">Lista de Proyectos de Usuario</h3>
                <hr>
                <br>
                    ...
                    <tbody>
                        <c:forEach items="${usuariosproyectos}" var="usuarioproyecto">
                            <tr>
                                ...
                                <td><a href="UsuarioProyectoControlador?action=edit&id=${usuarioproyecto.id}"" style="text-decoration: none; font-size: 15px" class="edit-button"">Editar</a></td>
                                <td><a href="UsuarioProyectoControlador?action=delete&id=${usuarioproyecto.id}"" style="text-decoration: none; font-size: 15px" class="delete-button"">Eliminar</a></td>
            ...
            <p><a href="UsuarioProyectoControlador?action=insert" class="proyectousuario-button"">Añadir Proyecto de Usuario</a></p>
