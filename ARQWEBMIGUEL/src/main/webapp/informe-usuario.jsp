...
<html>
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="container">
                <h3 class="text-center">Lista de marcajes del usuario ${nombre_usuario}</h3>
                <hr>
                <br>
                <table class="table table-striped">
                    ...
                    <tbody>
                        <c:forEach items="${marcajesUsuario}" var="marcaje">
                            <tr>
            ...
            <p><a href="UsuarioControlador?action=listUser"" style="text-decoration: none; font-size: 20px">Volver</a></p>
